            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcome-list shadow-reset">
                        <div class="row">
                            <div class="col-lg-6">
                                <a class="btn btn-info btn-lg" href="{{ route('category.create') }}">Add Category</a>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    @foreach($categories as $key=>$category)
                                        <tr>
                                            ...
                                            <td class="datatable-ct">
                                                <a class="btn btn-info" style="padding: 5px;" href="{{route('category.edit',$category->id)}}"><i class="fa fa-edit"></i></a>||
                                                <button style="padding: 5px;" href="" class="btn btn-danger" onclick="deleteMember({{$category->id}})"><i class="fa fa-remove"></i></button>
