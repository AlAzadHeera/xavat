...
@section('title','Add A New Testimonial')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Add New Testimonial</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <form method="post" action="{{ route('testimonial.store') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <textarea name="testimonial" id="summernote1" cols="30" rows="10"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                            ...
                                                            <div class="file-upload-inner ts-forms">
                                                                <div class="input prepend-big-btn">
                                                                    ...
                                                                    <div class="file-button">
                                                                        Browse
                                                                        <input type="file" name="avatar" onchange="document.getElementById('prepend-big-btn').value = this.value;">
                                                                    </div>
