                                        ...
                                        <div class="all-form-element-inner">
                                            <form method="post" action="{{ route('testimonial.update',$testimonial->id) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">Testimonial Text</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                            <textarea name="testimonial" id="summernote1" cols="30" rows="10">{!! $testimonial->testimonial !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
